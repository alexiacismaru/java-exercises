...
import a08_product.products.books.Book;
...
public class TestProducts {
	public static void main(String[] args) {
		...
		System.out.println(new Shirt("LAC5688","Antwrp",36.99,"M","L"));		Book book2 = new Book("455","Booker prize winner",26.22,"Bring up the bodies","Hillary Mantel");
